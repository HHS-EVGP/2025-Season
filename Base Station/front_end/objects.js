    ...
    draw(x_values,y_values){
        ...
        for (let i = 0; i < leng; i++) {
            if(y_values[i] == null){
                ...
                let x_point4 = (this.x-this.size/2+(1/8)*this.size) + ((((i+2)+0.5)/leng)*((this.x+this.size/2-(6*this.size/200))-(this.x-this.size/2+(1/8)*this.size)) + (2.5/64*this.size));
